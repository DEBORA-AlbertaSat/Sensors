...
while time.time() < end:
    ...
    start = time.process_time() #for measuring the length of the script, remove before flight
   ...
   # print("Humidity: %0.1f %%" % bme280.relative_humidity)
    ...
    scripttime = time.process_time() #for measuring the length of the script, remove before flight
